# Integrate-Vue3-Inertia-Bootstrap-with-Laravel10
...
Making sure we are in the desired folder we're going to require the Laravel's installer globally and then use it to create a new app called "**laravel10-vue3-inertia-bootstrap**" (this will automatically create the folder with the same name).
